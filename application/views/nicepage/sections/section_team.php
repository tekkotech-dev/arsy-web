            ...
            <?php if( !empty($get_personal)) {?>
                <div class="row justify-content-center">
                    ...
                    <div class="mb-4 mt-4 col-md-12">
                        <section id="slide-direksi" class="splide" aria-labelledby="carousel-heading">
                            <div class="splide__track">
                                <ul class="splide__list">
                                    <?php foreach($get_personal as $i => $person ) {?>
                                        <li class="splide__slide">
                                            <div class="body-container animate shadow-team-card height-card-direksi" style="border-radius: 15px;margin-right: 10px;margin-left: 10px;"> 
