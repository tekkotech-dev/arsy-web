			...
			<div class="row">			
				...
				<div class="col-md-12 text-center"> 
					...
					<h6>Temukan Kami Di</h6>
						...
						?>
						<a href="test" href="<?php echo $pecahd[0]; ?>" class="social-icon"><i class="fa fa-facebook" aria-hidden="true"></i></a>
						<a href="_BLANK" href="<?php echo $pecahd[1]; ?>" class="social-icon"><i class="fa fa-twitter" aria-hidden="true"></i></a>
						<a href="https://www.instagram.com/rsarsypaciran/?igshid=YmMyMTA2M2Y=" href="<?php echo $pecahd[2]; ?>" class="social-icon"><i class="fa fa-instagram" aria-hidden="true"></i></a>
						<a href="_BLANK" href="<?php echo $pecahd[3]; ?>" class="social-icon"><i class="fa fa-youtube" aria-hidden="true"></i></a>
					</div>
